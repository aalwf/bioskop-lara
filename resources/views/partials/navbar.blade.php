        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            @auth
                <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName" class="flex items-center text-sm pe-1 font-medium text-gray-900 rounded-full hover:text-blue-600 dark:hover:text-blue-500 md:me-0 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-white" type="button">
                    ...
                    <img class="w-8 h-8 me-2 rounded-full" src="{{ asset('profile/' . auth()->user()->image) }}" alt="user photo">
                    {{ auth()->user()->name }}
                ...
                <div id="dropdownAvatarName" class="z-10 hidden bg-gray-50 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-800 dark:divide-gray-700">
                    ...
                    <div class="py-2">
                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="block w-full text-left px-4 py-2 text-sm text-red-400 text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-red-400 dark:hover:text-red-500" type="button">
                            Logout
                        </button>
                    </div>
                </div>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Do you really want to logout?</h3>

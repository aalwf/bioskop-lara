...
<body>
    <div class="container p-4 mx-auto">
        ...
        <div class="w-full mt-10">
            <button class="w-full text-white font-semibold bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800" type="button" onclick="window.print()">
                Print Now
            </button>
        </div>

...
@section('main')
    ...
    <div class="grid gap-6 lg:grid-cols-3 md:grid-cols-2">
        ...
        <div class="bg-gray-100 dark:bg-gray-900 shadow shadow-gray-300 dark:shadow-gray-800 my-5 flex gap-4 rounded group">
            <div class="w-32 bg-cover bg-no-repeat bg-center rounded-l rounded-r-3xl shadow-lg dark:border-r-2 dark:border-indigo-500" style="background-image: url({{ url('storage/movies/' . $movie->image) }})"></div>
